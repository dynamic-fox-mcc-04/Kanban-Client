...
exports.default = _default;
        var $2be40f = exports.default || module.exports;
      
      if (typeof $2be40f === 'function') {
        $2be40f = $2be40f.options;
      }
    
        /* template */
        Object.assign($2be40f, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", [
    _vm.isError
      ? _c(
          "div",
          { staticClass: "msg msg-error  z-depth-1" },
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "title" }, [_c("h2", [_vm._v("Login")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2be40f', $2be40f);
          } else {
            api.reload('$2be40f', $2be40f);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/RegisterForm.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $eb3e2a = exports.default || module.exports;
      
      if (typeof $eb3e2a === 'function') {
        $eb3e2a = $eb3e2a.options;
      }
    
        /* template */
        Object.assign($eb3e2a, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    [
      _vm.isSuccess
        ? _c("lottie-player", {
            ...
            attrs: {
              src: "https://assets8.lottiefiles.com/packages/lf20_OcSwPS.json",
            ...
            _c(
              ...
              [
                ...
                _c(
                  ...
                  {
                    staticClass: "btn waves-effect waves-light",
                    attrs: { type: "submit", name: "action", color: "primary" }
                  },
                  [_vm._v("Sign Up")]
                ),
                _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "title" }, [_c("h2", [_vm._v("Register")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$eb3e2a', $eb3e2a);
          } else {
            api.reload('$eb3e2a', $eb3e2a);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/views/Home.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $cc0a6b = exports.default || module.exports;
      
      if (typeof $cc0a6b === 'function') {
        $cc0a6b = $cc0a6b.options;
      }
    
        /* template */
        Object.assign($cc0a6b, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.isLogin
        ? _c("login-form", {
            on: { Status: _vm.changeStatus, loginStatus: _vm.loginSuccess }
          })
        : !_vm.isLogin
        ? _c("register-form", { on: { Status: _vm.changeStatus } })
        : _vm._e()
    ],
    1
  )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$cc0a6b', $cc0a6b);
          } else {
            api.reload('$cc0a6b', $cc0a6b);
          }
        }
...
},{"sortablejs":"node_modules/sortablejs/modular/sortable.esm.js"}],"src/views/Dashboard.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    addTask: function addTask(categoryId) {
      var _this2 = this;
    ...
    toggleTask: function toggleTask(category) {
    ...
    getCategory: function getCategory() {
      ...
      (0, _axios.default)({
        ...
        result.data.categories.forEach(function (el) {
          el.statusOpen = false;
        });
    ...
    getTasks: function getTasks() {
      ...
      (0, _axios.default)({
        ...
        _this4.tasks = result.data.tasks;
      }).catch(function (err) {
        console.log(err);
      });
    },
    ...
    _c(
      ...
      [
        _vm._l(_vm.categories, function(category) {
          return _c(
            "div",
            { key: category.id, staticClass: "card-list" },
            [
              _c("div", { staticClass: "card-title" }, [
                _c("h3", [_c("b", [_vm._v(_vm._s(category.name))])])
              ]),
              _vm._v(" "),
              _c(
                "draggable",
                {
                  attrs: { id: category.id, options: { group: "tasks" } },
                  on: {
                ...
                _vm._l(_vm.tasks, function(task) {
                  return _c(
                    "div",
                    { key: task.id, staticClass: "card-content-box" },
                    [
              ...
              !category.statusOpen
                ? _c("div", [
                    _c("div", { staticClass: "card-btn" }, [
                      _c(
                        "button",
                        {
                          on: {
                            click: function($event) {
                              return _vm.toggleTask(category)
                            }
                          }
                        },
                        [_vm._v("+  add task")]
                    ...
                    _c(
                      "form",
                      {
                        on: {
                          submit: function($event) {
                            $event.preventDefault()
                            return _vm.addTask(category.id)
                          }
                        }
                      },
                      [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "card-list-add" }, [
          _vm.isVisiblity
            ? _c(
                "form",
                {
                ...
                [
                  ...
                  _c(
                    "button",
                    { staticClass: "btn green", attrs: { type: "submit" } },
                    [_vm._v("Add Category")]
                  ),
                  _vm._v(" "),
                  _c(
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$fff802', $fff802);
          } else {
            api.reload('$fff802', $fff802);
          }
        }
...
},{"axios":"node_modules/axios/index.js","vuedraggable":"node_modules/vuedraggable/dist/vuedraggable.common.js","_css_loader":"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/App.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $7611f5 = exports.default || module.exports;
      
      if (typeof $7611f5 === 'function') {
        $7611f5 = $7611f5.options;
      }
    
        /* template */
        Object.assign($7611f5, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      !_vm.isLogin
        ? _c("home", { on: { loginStatus: _vm.loginSuccess } })
        : _c("dashboard", { on: { loginStatus: _vm.loginSuccess } })
    ],
    1
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7611f5', $7611f5);
          } else {
            api.reload('$7611f5', $7611f5);
          }
        }
...
},{"axios":"node_modules/axios/index.js","./views/Home":"src/views/Home.vue","./views/Dashboard":"src/views/Dashboard.vue","_css_loader":"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
