...
var _default = {
  ...
  methods: {
    ...
    updateTask: function updateTask(taskId, idx) {
      var _this5 = this;
    ...
    toggleMove: function toggleMove(task) {
      if (task.statusMove) {
    ...
    toggleEdit: function toggleEdit(task) {
      if (task.editable) {
        task.editable = false;
      } else {
        task.editable = true;
                ...
                : _c(
                    "form",
                    {
                      on: {
                        submit: function($event) {
                          $event.preventDefault()
                          return _vm.updateCategory(category.id)
                        }
                      }
                    },
                    [
                    ...
                    _c(
                      ...
                      [
                        _c("input", {
                          ...
                          attrs: { placeholder: "Enter Task here" },
                          domProps: { value: _vm.data.title },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
