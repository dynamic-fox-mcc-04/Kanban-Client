...
exports.default = _default;
        var $49b7fe = exports.default || module.exports;
      
      if (typeof $49b7fe === 'function') {
        $49b7fe = $49b7fe.options;
      }
    
        /* template */
        Object.assign($49b7fe, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$49b7fe', $49b7fe);
          } else {
            api.reload('$49b7fe', $49b7fe);
          }
        }
